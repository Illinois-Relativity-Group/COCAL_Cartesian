...
!  use interface_excurve_CF_gridpoint_export
  ...
  implicit none
  integer :: impt, impt_ex, ico, irr, isp, igrid, ix, iy, iz, res, i, file_unit
...
!
  ...
  write(file_unit, '(1p,24A23)') &
     '#','x', 'y', 'z', 'rho', 'psi', 'alph', 'bvxd', 'bvyd', 'bvzd', 'vxu', &
     'vyu', 'vzu', 'kxx', &
  ...
  !rite(6,'(a38,2e20.12)') "Cocal radius scale in COCP-1, COCP-2 :", radi_p1, radi_p2
...
!
  ...
  write(file_unit, '(1p, 23E23.15)') &
      xcac, ycac, zcac, rhoca, psica, alphca, bvxdca, bvydca, bvzdca, vxu, &
      vyu, vzu, kxx, &
      kxy, kxz, kyy, kyz, kzz, emdca, ome_p1/radi_p1, hca, eneca, epsca
